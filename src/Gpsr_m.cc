...
Register_Class(GpsrBeaconModified)

GpsrBeaconModified::GpsrBeaconModified() : ::inet::FieldsChunk()
{
}

GpsrBeaconModified::GpsrBeaconModified(const GpsrBeaconModified& other) : ::inet::FieldsChunk(other)
{
    copy(other);
}

GpsrBeaconModified::~GpsrBeaconModified()
{
}

GpsrBeaconModified& GpsrBeaconModified::operator=(const GpsrBeaconModified& other)
{
...
void GpsrBeaconModified::copy(const GpsrBeaconModified& other)
{
    this->address = other.address;
    this->position = other.position;
}

void GpsrBeaconModified::parsimPack(omnetpp::cCommBuffer *b) const
{
...
void GpsrBeaconModified::parsimUnpack(omnetpp::cCommBuffer *b)
{
...
const L3Address& GpsrBeaconModified::getAddress() const
{
    return this->address;
}

void GpsrBeaconModified::setAddress(const L3Address& address)
{
    handleChange();
    this->address = address;
}

const Coord& GpsrBeaconModified::getPosition() const
{
    return this->position;
}

void GpsrBeaconModified::setPosition(const Coord& position)
{
    handleChange();
    this->position = position;
}

class GpsrBeaconModifiedDescriptor : public omnetpp::cClassDescriptor
{
  private:
  ...
  public:
    GpsrBeaconModifiedDescriptor();
    virtual ~GpsrBeaconModifiedDescriptor();
...
Register_ClassDescriptor(GpsrBeaconModifiedDescriptor)

GpsrBeaconModifiedDescriptor::GpsrBeaconModifiedDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::GpsrBeaconModified)), "inet::FieldsChunk")
{
    propertynames = nullptr;
}

GpsrBeaconModifiedDescriptor::~GpsrBeaconModifiedDescriptor()
{
    delete[] propertynames;
}

bool GpsrBeaconModifiedDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<GpsrBeaconModified *>(obj)!=nullptr;
}

const char **GpsrBeaconModifiedDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *GpsrBeaconModifiedDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}

int GpsrBeaconModifiedDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 2+basedesc->getFieldCount() : 2;
}

unsigned int GpsrBeaconModifiedDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
...
const char *GpsrBeaconModifiedDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int GpsrBeaconModifiedDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *GpsrBeaconModifiedDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char **GpsrBeaconModifiedDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *GpsrBeaconModifiedDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int GpsrBeaconModifiedDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    GpsrBeaconModified *pp = (GpsrBeaconModified *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *GpsrBeaconModifiedDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string GpsrBeaconModifiedDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool GpsrBeaconModifiedDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *GpsrBeaconModifiedDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *GpsrBeaconModifiedDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
